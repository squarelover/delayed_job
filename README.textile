...
delayed_job supports multiple backends for storing the job queue. There are currently implementations for Active Record, MongoMapper, Mongoid, and DataMapper.
